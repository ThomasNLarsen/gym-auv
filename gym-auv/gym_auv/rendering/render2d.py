...
def _render_indicators(env, W, H):
    ...
    '''
    env._viewer2d.eta_text_field.text = "Speed:"
    env._viewer2d.eta_text_field.draw()
    env._viewer2d.eta_value_field.text = "{:.2f}".format(env.vessel.speed())
    env._viewer2d.eta_value_field.draw()
    
    env._viewer2d.eta_text_field.text = "Inputs:"
    env._viewer2d.eta_text_field.draw()
    env._viewer2d.eta_value_field.text = "{:.2f}".format(env.vessel._input[0], env.vessel._input[1])
    env._viewer2d.eta_value_field.draw()
    '''
